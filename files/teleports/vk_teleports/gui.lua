...
Citizen.CreateThread(function()
	while true do
		...
		if gui_interiors.opened then
            ...
            gui_interiors_drawTxt(gui_interiors.selectedbutton.."/"..exports.online_interiors:tablelength(menu.buttons),0,0,gui_interiors.menu.x + gui_interiors.menu.width/2 - 0.0385,gui_interiors.menu.y + 0.067,0.4, 255,255,255,255)
            ...
            buttoncount = exports.online_interiors:tablelength(menu.buttons)
